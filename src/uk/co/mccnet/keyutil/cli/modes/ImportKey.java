...
public class ImportKey implements CliMode {
	Options options;
	...
	public ImportKey() {
		...
		Option pemFilename 		= OptionBuilder.hasArg()
												.withLongOpt("certs")
												.withDescription("pem file")
												.withArgName("FILENAME [FILENAME]..")
												.isRequired()
												.hasArgs()
												.create("c");

		Option keyFilename 		= OptionBuilder.hasArg()
												.withLongOpt("key")
												.withDescription("key file in PEM format")
												.withArgName("FILENAME [FILENAME]..")
												.isRequired()
												.hasArg()
												.create("e");
